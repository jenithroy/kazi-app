/**
 * The Kazi component kit. Import from "components/ui"; each component lives in
 * its own file in this folder. /__kit (dev builds only) shows every component
 * in every state.
 */
...
export { CHART_COLORS, CHART_TONES, chartColor, tooltipProps, gridProps, axisProps, shortNumber } from "./charts";
export { placeFloating } from "./floating";

...
const COLLECTIONS = {
  ...
  messenger_tabs:     { view: null,                    table: 'messenger_tabs' },
  marketing_tabs:     { view: null,                    table: 'marketing_tabs' },
  position_permissions:  { view: null, table: 'position_permissions' },
  position_finance_tabs: { view: null, table: 'position_finance_tabs' },
  position_messenger_tabs: { view: null, table: 'position_messenger_tabs' },
  position_marketing_tabs: { view: null, table: 'position_marketing_tabs' },
  point_transactions: { view: null,                    table: 'point_transactions' },
  meta_ad_accounts:   { view: 'fs_meta_ad_accounts',   table: 'meta_ad_accounts' },
  meta_campaigns:     { view: 'fs_meta_campaigns',     table: 'meta_campaigns' },
  meta_adsets:        { view: 'fs_meta_adsets',        table: 'meta_adsets' },
  meta_ads:           { view: 'fs_meta_ads',           table: 'meta_ads' },
  meta_ad_insights:   { view: 'fs_meta_ad_insights',   table: 'meta_ad_insights' },
  meta_campaign_insights: { view: 'meta_campaign_insights', table: 'meta_campaign_insights' },
  meta_sync_runs:     { view: 'fs_meta_sync_runs',     table: 'meta_sync_runs' },
  meta_ads_actions:   { view: 'fs_meta_ads_actions',   table: 'meta_ads_actions' },
  meta_ads_settings:  { view: 'fs_meta_ads_settings',  table: 'meta_ads_settings' },

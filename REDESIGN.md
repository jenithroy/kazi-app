...
> Status: **plan only, nothing built yet.** Review this, answer the open decisions in §12, then we build it phase by phase.
...
Their CSS goes with them: `kacc-2col`, the `[style*="repeat(7"]` hack, `secondary-button`, `stat-card`.
...
## 12. Open decisions (please answer before Phase 0)
